...
#     video_length_new = np.linspace(video_length_fitline[0], video_length_fitline[-1], num=len(video_length_fitline))
...
#     f_length_Senson_PI_nonlinearity_P, fft, FFT_length_Senson_PI_nonlinearity_P, phi = FFT_cal(length_Senson_PI_nonlinearity_P, (length_Senson_PI_new[1]-length_Senson_PI_new[0]))
    ...
    hor_SmarAct = np.arctan(np.array(-SmarAct_diff/3.5e6))*1e6 ### 5mm distance
    hor_SmarAct_PI_Nonlinearity = hor_SmarAct - Hor_PI
    hor_SmarAct_PI_Nonlinearity = hor_SmarAct_PI_Nonlinearity - np.average(hor_SmarAct_PI_Nonlinearity)
    f_hor_SmarAct_PI_Nonlinearity, fft, FFT_hor_SmarAct_PI_Nonlinearity, phi = FFT_cal(hor_SmarAct_PI_Nonlinearity, 1/fs)
...
if 1:  
    ...
    plt.subplot(3,3,2)
    plt.plot(timeline, video_length_nonlinearity_T, color='blue', label='video_length_nonlinearity_Time')
#     plt.plot(video_length, video_length_nonlinearity_P, color='red', label='video_length_nonlinearity_Pos.')
    ...
    plt.subplot(3,3,3)
    plt.loglog(f_video_ver_nonlinearity, FFT_video_length_nonlinearity_T, color='blue', label='video_length_nonlinearity_Time')
...
#     plt.gca().invert_xaxis()
    ...
    plt.subplot(3,3,5)
    plt.plot(timeline, length_Senson_SmarAct_nonlinearity_T, color='blue', label='diff_nonlinearity_Time')
#     plt.plot(SmarAct_common, length_Senson_SmarAct_nonlinearity_P, color='red', label='diff_nonlinearity_Pos.')
    ...
    plt.subplot(3,3,6)
    plt.loglog(f_length_Senson_SmarAct_nonlinearity, FFT_length_Senson_SmarAct_nonlinearity_T, color='blue', label='diff_nonlinearity_Time')
...
#     plt.xlim(1e3,30)
    ...
    plt.subplot(3,3,8)
    plt.plot(timeline, length_Senson_PI_nonlinearity_T, color='blue', label='diff_nonlinearity_Time')
#     plt.plot(video_length, length_Senson_PI_nonlinearity_P, color='red', label='diff_nonlinearity_Pos.')
    ...
    plt.subplot(3,3,9)
    plt.loglog(f_length_Senson_PI_nonlinearity, FFT_length_Senson_PI_nonlinearity_T, color='blue', label='diff_nonlinearity_Time')
...
#     plt.xlim(1e3,30)
    ...
    plt.plot(timeline, hor_angle-np.average(hor_angle), color='cyan', label='hor: Video')
    ...
    plt.subplot(2,3,2)
    plt.plot(timeline, video_hor_nonlinearity_T, color='blue', label='hor_video-PI_nonlinearity_Time')
    plt.plot(timeline, hor_SmarAct_PI_Nonlinearity, color='green', label='hor_SmarAct-PI_nonlinearity_Time')
#     plt.plot(video_length, video_hor_nonlinearity_P, color='red', label='hor_video-PI_nonlinearity_Pos.')
    ...
    plt.subplot(2,3,3)
    plt.loglog(f_video_hor_nonlinearity, FFT_video_hor_nonlinearity_T, color='blue', label='hor_video-PI_nonlinearity_Time')
    plt.loglog(f_hor_SmarAct_PI_Nonlinearity, FFT_hor_SmarAct_PI_Nonlinearity, color='green', label='hor_SmarAct-PI_nonlinearity_Time')
...
#     plt.xlim(1e3,30)
    ...
    plt.subplot(2,3,5)
    plt.plot(timeline, video_ver_nonlinearity_T, color='blue', label='video_ver_angle_nonlinearity_Time')
#     plt.plot(video_length, video_ver_nonlinearity_P, color='red', label='video_ver_angle_nonlinearity_Pos.')
    ...
    plt.subplot(2,3,6)
    plt.loglog(f_video_ver_nonlinearity, FFT_video_ver_nonlinearity_T, color='blue', label='ver_video-PI_nonlinearity_Time')
